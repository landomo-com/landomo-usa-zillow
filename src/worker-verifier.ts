/**
 * QuintoAndar Missing Property Verifier - Verify and Disable Missing Properties
 *
...
async function main() {
  ...
  logger.info('Starting QuintoAndar Missing Property Verifier');
  ...
  try {
    ...
    // Show queue stats
    const queue = new RedisQueue('quintoandar');
